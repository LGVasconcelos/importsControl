...
const styles: Record<string, React.CSSProperties> = {
  ...
  searchInput: { padding: '9px 14px', border: '1.5px solid #e2e8f0', borderRadius: 8, width: 300, fontSize: 14 },
  ...
  modal: { background: '#fff', borderRadius: 14, padding: '28px 32px', width: '100%', maxWidth: 680, maxHeight: '90vh', overflow: 'auto' },
